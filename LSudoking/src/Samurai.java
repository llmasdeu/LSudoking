...
/**
 * Subclasse de sudoku, encarregada dels sudokus Samurai.
 * @author Lluís Masdeu
 * @author Patrick Albó
 *
 */
public class Samurai extends Sudoku {
	 ...
	 */
	public Samurai(int[][] sudoku, boolean[][] fixed, int sSize, int gSize, String outputFile, int outputMode, MarkingManager markingManager, int tSolutions, String outputFileContent) {
