...
/**
 * Subclasse de sudoku, encarregada dels sudokus 9x9.
 * @author Lluís Masdeu
 * @author Patrick Albó
 *
 */
public class NineByNine extends Sudoku {
	/**
	 * Constructor.
	 ...
	 */
	public NineByNine(int[][] sudoku, boolean[][] fixed, int sSize, int gSize, String outputFile, int outputMode, MarkingManager markingManager, int tSolutions, String outputFileContent) {
